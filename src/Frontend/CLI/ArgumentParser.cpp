...
void enableLoggingSubsystem( Subsystem subsystem, Waterrower::Logger::LogLevel loglevel )
{
    switch( subsystem )
    {
...
{
   SubsystemParser( Waterrower::Logger::LogLevel loglevel )
...
QStringList parseSubsystems( const QString & line, Waterrower::Logger::LogLevel loglevel )
{
...
void ArgumentParser::process(const QCoreApplication & app)
{
    ...
    Logger::LogLevel loglevel( ArgumentParser::handleTraces( traces ) );
    ArgumentParser::handleSubsystems( subsystems, loglevel );
}

void ArgumentParser::handleSubsystems(QCommandLineOption & subsystemOption, Waterrower::Logger::LogLevel loglevel )
{
...
Waterrower::Logger::LogLevel ArgumentParser::handleTraces( QCommandLineOption & traces )
{
    Waterrower::Logger::LogLevel loglevel( Waterrower::Logger::LogLevel_NoLogging );
    ...
    if( QCommandLineParser::isSet( traces ) )
    {
        ...
        {
        case 1:
            loglevel = Waterrower::Logger::LogLevel_Basic;
            break;
        case 2:
            loglevel = Waterrower::Logger::LogLevel_Extended;
            break;
        case 3:
            loglevel = Waterrower::Logger::LogLevel_All;
            break;
        default:
